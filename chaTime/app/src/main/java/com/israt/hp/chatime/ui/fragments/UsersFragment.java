...
import com.israt.hp.chatime.core.users.get.all.GetUsersContract;
import com.israt.hp.chatime.core.users.get.all.GetUsersPresenter;
import com.israt.hp.chatime.models.User;
import com.israt.hp.chatime.ui.activities.ChatActivity;
import com.israt.hp.chatime.ui.adapters.UserListingRecyclerAdapter;
import com.israt.hp.chatime.utils.ItemClickSupport;
...
public class UsersFragment extends Fragment implements GetUsersContract.View, ItemClickSupport.OnItemClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private void getUsers() {
        if (TextUtils.equals(getArguments().getString(ARG_TYPE), TYPE_CHATS)) {
         ...
         mGetUsersPresenter.getAllUsers(UsersFragment.this.getActivity());
            //Toast.makeText(UsersFragment.this.getActivity(),"Please activate your internet",Toast.LENGTH_SHORT).show();
    ...
    public void onGetAllUsersSuccess(List<User> users) {
        ...
        mUserListingRecyclerAdapter = new UserListingRecyclerAdapter(UsersFragment.this,users);
